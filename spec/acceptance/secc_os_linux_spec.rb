...
describe 'Class secc_os_linux' do
  context 'with default config' do
    ...
    <<-EOS
      class { 'secc_os_linux':
        rootsh_enabled => false,
        secure_mountpoint_tmp => false,
        secure_mountpoint_var => false,
        secure_mountpoint_var_tmp => false,
        secure_mountpoint_home => false,
      }
    EOS
    }
...
####
  ...
  describe file('/etc/modprobe.d/secc-blacklist.conf') do
    ...
    # TODO: mountpoints not in test image
#  # mounts
#  # req. 24 / 3_21 Unix
